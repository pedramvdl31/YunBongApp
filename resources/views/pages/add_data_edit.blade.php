...
@section('stylesheets')
  ...
  <script src="/assets/js/pages/add_data_edit.js"></script>
...
<div class="panel panel-default">
  <div class="panel-body" style="padding:0">
    ...
    <div id="myTabContentx" class="tab-contentx">
      <div id="form-1">
        {!! Form::open(array('action' => 'PagesController@postEditPreviewStep', 'id'=>'fileupload', 'class'=>'top-form','role'=>"form")) !!}
                ...
                <div class="panel-body">
                  <div class="form-group {{ $errors->has('title') ? 'has-error' : false }}">
                    <label class="control-label" for="title">Header Text</label>
                      @if(isset($step_2_data['header_text']))
                        {!! Form::text('header_text', $step_2_data['header_text'], array('class'=>'form-control', 'placeholder'=>'Header Text')) !!}
                      @elseif($this_page_data['page_content']['header_text'])
                        {!! Form::text('header_text', $this_page_data['page_content']['header_text'], array('class'=>'form-control', 'placeholder'=>'Header Text')) !!}
                      @else
          ...
          @if(isset($step_2_data['files']))
            ...
            <div class="my-tab container panel 
              ...
              <div id="imageDiv" class="hide">
                @foreach($step_2_data['files'] as $srcskey => $srcs)
                  <input class="images" name="files[{{$srcskey}}][path]" type="hidden" value="{!!$srcs['path']!!}"/>
                @endforeach
              </div>
              <div id="imageDiv-single" class="hide">
                @if(isset($step_2_data['file-single'][0]['path']))
                    <input class="images-single" name="file-single[0][path]" type="hidden" value="{!!$step_2_data['file-single'][0]['path']!!}"/>
                @endif
              </div>
              <div class="row">
                @foreach($step_2_data['files'] as $srcs)
            ...
            @endif
          @elseif(isset($preview_session_data['page_slider_option']))
            @if($preview_session_data['page_slider_option'] != 0)
            ...
            <div class="my-tab container panel 
              ...
              <div id="imageDiv" class="hide">
                @if(isset($this_page_data['page_content']['files']))
                  @foreach($this_page_data['page_content']['files'] as $srcskey => $srcs)
                    <input class="images" name="files[{{$srcskey}}][path]" type="hidden" value="{!!$srcs['path']!!}"/>
                  @endforeach
                @endif
              </div>
              <div id="imageDiv-single" class="hide">
                @if(isset($this_page_data['page_content']['file-single'][0]['path']))
                    <input class="images-single" name="file-single[0][path]" type="hidden" value="{!!$this_page_data['page_content']['file-single'][0]['path']!!}"/>
                @endif
              </div>
                  @if(isset($this_page_data['page_content']['files']))
                      <div class="row" style="margin-top: 20px;">
                        @foreach($this_page_data['page_content']['files'] as $srcs)
                           <div class="existingImagesDiv col-sm-6 col-md-4">
                            <div class="thumbnail">
                              <img class="image-url" style="max-height:140px; max-width:100%;" src="{!!$srcs['path']!!}" data-holder-rendered="true" style="height: 180px; width: 100%; display: block;">
                              <div class="caption">
                ...
                <div class="panel-body section-wrapper">
                  ...
                  @for ($i = 0; $i < $preview_session_data['page_section_number']; $i++)
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : false }}">
                      ...
                      @if(isset($step_2_data['section'][$i]['title']))
                        {!! Form::text('section['.$i.'][title]', $step_2_data['section'][$i]['title'], array('class'=>'form-control', 'placeholder'=>'Title')) !!}
                      @elseif(isset($this_page_data['page_content']['section']))
                        @if(isset($this_page_data['page_content']['section'][$i]['title']))
                          {!! Form::text('section['.$i.'][title]', $this_page_data['page_content']['section'][$i]['title'], array('class'=>'form-control', 'placeholder'=>'Title')) !!}
                        @else
                    ...
                    <div class="form-group {{ $errors->has('description') ? 'has-error' : false }}">
                      ...
                      @if(isset($step_2_data['section'][$i]['description']))
                        {!! Form::textarea('section['.$i.'][description]', $step_2_data['section'][$i]['description'], ['class' => 'des field form-control','size' => '30x3', 'placeholder'=>'Description']) !!}
                      @elseif(isset($this_page_data['page_content']['section']))
                        @if(isset($this_page_data['page_content']['section'][$i]['description']))
                          {!! Form::textarea('section['.$i.'][description]', $this_page_data['page_content']['section'][$i]['description'], ['class' => 'des field form-control','size' => '30x3', 'placeholder'=>'Description']) !!}
                        @else
      ...
      <div id="form-2">
        {!! Form::open(array('action' => 'PagesController@postEditPreviewStep', 'id'=>'fileupload', 'class'=>'','role'=>"form")) !!}
              ...
              <div class="my-tab container
                ...
                @if(isset($step_2_data['file-single'][0]['path']))
                  <div class="row single-image-container" style="margin-top: 20px;">
                    <div class="existingImagesDiv col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img class="image-url" style="max-height:140px; max-width:100%;" src="{!!$step_2_data['file-single'][0]['path']!!}" data-holder-rendered="true" style="height: 180px; width: 100%; display: block;">
                        <div class="caption">
                          <h3>Options</h3>
                          <button type="button" class="viewImage btn btn-default btn-sm pull-right view-image">View</button>
                ...
                @elseif(isset($this_page_data['page_content']['file-single'][0]['path']))
                  <div class="row single-image-container" style="margin-top: 20px;">
                    <div class="existingImagesDiv col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img class="image-url" style="max-height:140px; max-width:100%;" src="{!!$this_page_data['page_content']['file-single'][0]['path']!!}" data-holder-rendered="true" style="height: 180px; width: 100%; display: block;">
                        <div class="caption">
                          <h3>Options</h3>
                          <button type="button" class="viewImage btn btn-default btn-sm pull-right view-image">View</button>
                          <button type="button" class="removeImage btn btn-danger btn-sm delete-image-single">Delete</button>
  ...
  <div class="panel-footer clearfix">
    ...
    <a href="{!!route('pages_edit',$page_id)!!}" class="btn btn-info pull-left" type="submit">Back</a>
  </div>
</div>
