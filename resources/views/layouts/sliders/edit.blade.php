...
<script type="text/javascript" src="/assets/js/pages/sliders/edit.js"></script>
...
@section('content')
  {!! Form::open(array('action' => 'PagesController@postSlidersEdit', 'id'=>'fileupload', 'class'=>'','role'=>"form")) !!}
  ...
  <div class="panel-body">
        <div class="form-group {{ $errors->has('pages') ? 'has-error' : false }}">
          <label class="control-label" for="pages">Page Title</label>
            <h4 style="color:black">&nbsp{{$title}}</h4>
    ...
    <div class="panel-body">
      <div class="col-lg-12 col-md-12">
        @if(isset($data['images']))
          @foreach($data['images'] as $key => $image_src)
          <div class="existingImagesDiv col-sm-6 col-md-4">
            <div class="thumbnail">
              <img class="image-url" style="max-height:140px; max-width:100%;" src="/assets/images/sliders/{{$title}}/{!! $image_src !!}">
