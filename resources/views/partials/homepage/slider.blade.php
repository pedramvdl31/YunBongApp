...
<body style="font-family:Arial, Verdana;background-color:#fff;">
    ...
    <script type="text/javascript" src="/packages/jssor/js/jquery-1.9.1.min.js"></script>
    <!-- use jssor.slider.mini.js (40KB) instead for release -->
    <!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
    <script type="text/javascript" src="/packages/jssor/js/jssor.js"></script>
    <script type="text/javascript" src="/packages/jssor/js/jssor.slider.js"></script>
    <script>
    ...
    <div class="z-index-bottom" id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 600px; height: 200px; overflow: hidden; ">
        ...
        @if(isset($slider_images))
            ...
            @foreach($slider_images as $imgs)
                <div>
                    <img u="image" src="/assets/images/sliders/{!! $param1_lowered !!}/{!!$imgs!!}" />
                </div>
            @endforeach
        @else

            <div>
                <img u="image" src="/assets/images/sliders/slider-placeholder-poJuzHS81k9.png" />
            </div>  
        @endif
        ...
        <style>
            ...
            */
            ...
            .jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
                ...
                width: 16px;
                height: 16px;
                background: url(/packages/jssor/img/b05.png) no-repeat;
                overflow: hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora12l, .jssora12r {
                ...
                height: 46px;
                cursor: pointer;
                background: url(/packages/jssor/img/a12.png) no-repeat;
                overflow: hidden;
            }
